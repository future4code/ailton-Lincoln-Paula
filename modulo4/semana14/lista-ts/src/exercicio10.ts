// O CPF consiste de 11 dígitos cuja configuração respeita o formato XXX.XXX.XXX-XX. Para a 
// construção de um número de CPF as seguintes regras são aplicadas.
...
// Para o cálculo dos DV existem pesos associados a cada dígito, abaixo segue exemplo 
// do cálculo dos DV do CPF com número-base 145382206.

// - Exemplo de cálculo do primeiro Dígito Verificador
    
//     Começamos utilizando os 9 primeiros dígitos multiplicando-os pela sequência 
//     decrescente de 10 à 2 e somamos esse resultado.
...
//     O resto da divisão é `9`. Agora para calcular o dígito verificador vamos subtrair e
//     ste resto do número 11:
