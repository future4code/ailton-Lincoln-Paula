...
// function brincandoDeCartinhas(carta1User, carta2User, carta1Pc, carta2Pc){
//    if(confirm(`Bem-vinde ao jogo de Blackjack !
//    Quer iniciar uma nova rodada ?` )){

//    confirm(`Suas cartas são ${carta1User.texto}, ${carta2User.texto} A carta revelada do computador é ${carta1Pc.texto}
...
//       alert("O jogo acabou.")
//    }}
//    brincandoDeCartinhas(comprarCarta(), comprarCarta(), comprarCarta(), comprarCarta())